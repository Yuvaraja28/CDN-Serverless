/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a04d16ee1ef4c8709fad952ce3ce8800)
...
declare namespace Cloudflare {
	...
	interface Env {
		DEVLEY_RATELIMITER: RateLimit;
		MITILENCE_25_RATELIMITER: RateLimit;
		YUVARAJA_RATELIMITER: RateLimit;
		ROUTES_JSON: string;
		CACHE_TTL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROUTES_JSON" | "CACHE_TTL">> {}
}
